...
import { getFollowList, unfollowRentaler } from '../../services/fetch/ApiUtils';
...
function Follow(props) {
    ...
    const fetchData = () => {
        getFollowList(currentPage - 1, itemsPerPage).then(response => {
    ...
    const handleUnfollow = (rentalerId) => {
        setLoadingUnfollow(prev => ({ ...prev, [rentalerId]: true }));
        
        unfollowRentaler(rentalerId)
            .then(response => {
            ...
            .finally(() => {
                setLoadingUnfollow(prev => ({ ...prev, [rentalerId]: false }));
            });
    }
                                ...
                                <div className="row">
                                    {tableData.length > 0 ? (
                                                        ...
                                                        <div className="card-footer-d">
                                                            ...
                                                            <div className="d-flex justify-content-center mt-2">
                                                                <button
                                                                    ...
                                                                    onClick={() => handleUnfollow(item.rentaler.id)}
                                                                    disabled={loadingUnfollow[item.rentaler.id]}
                                                                    style={{ minWidth: '120px' }}
                                                                >
                                                                    {loadingUnfollow[item.rentaler.id] ? (
                                                                        <>
                                        ...
                                        <div className="col-12 text-center py-5">
                                            <p className="text-muted">Bạn chưa theo dõi chủ trọ nào.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
